...
<tr>
<td class="tl">网站地址</td>
<td><input name="config[url]" type="text" value="<?php echo $url;?>" size="40"/><?php tips('请添写完整URL地址,例如http://www.krrjgf.com/<br/>注意以 / 结尾');?></td>
</tr>
<tr>
...
<tr>
<td class="tl">短信余额</td>
<td><span class="f_red"><script type="text/javascript" src="http://www.krrjgf.com/sms.php?uid=<?php echo $sms_uid;?>&key=<?php echo $sms_key;?>"></script></span> 条 <a href="?file=cloud&action=sms" target="_blank" class="t">[在线充值]</a></td> 
</tr>
<?php } ?>
<tr>
...
<td><input name="config[com_domain]" type="text" value="<?php echo $com_domain;?>" size="30"/> <?php tips('如果填写 .krrjgf.com 同时需要将域名泛解析 *.krrjgf.com 指向服务器IP，并且在服务器端绑定泛域名至 网站根目录 或者 网站根目录/company 目录，生成的主页形式为username.krrjgf.com<br/>如果填写 i.krrjgf.com 同时需要将域名泛解析 i.krrjgf.com 指向服务器IP，并且在服务器端绑定域名至网站根目录/company 目录，生成的主页形式为i.krrjgf.com/username/(注：此方式必须支持伪静态)');?></td>
</tr>
<tr>
...
<input type="radio" name="setting[com_www]" value="0"  <?php if(!$com_www){ ?>checked <?php } ?>/> 关闭 <?php tips('例如二级域名为sell.krrjgf.com<br/>添加www后为 www.sell.krrjgf.com');?>
</td>
</tr>
<tr>
...
<td><input name="setting[remote_url]" type="text" value="<?php echo $remote_url;?>" size="60"/><?php tips('例如 http://static.krrjgf.com/，注意以 / 结尾');?></td>
</tr>
<tr> 
...
<tr>
<td class="tl">信任域名</td>
<td><input name="setting[safe_domain]" type="text" value="<?php echo $safe_domain;?>" size="60"/><?php tips('不填写则默认为当前域名<br/>多个域名请用|分开 例如krrjgf.com|krrjgf.cn');?></td>
</tr>
<tr>
...
<td><input name="config[cookie_domain]" type="text" value="<?php echo $cookie_domain;?>" size="20"/><?php tips('例如要保证顶级域名krrjgf.com所有二级域名均可正常登录注销，则填写.krrjgf.com(注意顶级域名前加.)');?></td>
</tr>
<tr>
