...
<tr>
<td class="tl">程序信息</td>
<td>&nbsp;<a href="?file=cloud&action=update" class="t">krrjgf B2B Version <?php echo DT_VERSION;?> Release <?php echo DT_RELEASE;?> <?php echo strtoupper(DT_CHARSET);?> <?php echo strtoupper(DT_LANG);?> [检查更新]</a></td>
</tr>
<tr>
<td class="tl">软件版本</td>
<?php if($edition == '&#20010;&#20154;&#29256;') { ?>
<td id="krrjgf_edition">&nbsp;<span class="f_blue"><?php echo $edition;?></span> <span class="f_red">(未授权)</span>&nbsp;&nbsp;<a href="?file=cloud&action=buy" target="_blank" class="t">[购买授权]</a></td>
<?php } else { ?>
<td id="krrjgf_edition">&nbsp;<span class="f_blue">商业<?php echo $edition;?></span>&nbsp;&nbsp;<a href="?file=cloud&action=biz" target="_blank" class="t" title="技术支持">[技术支持]</a></td>
<?php } ?>
</tr>
<tr>
<td class="tl">安装时间</td>
...
<tr>
<td class="tl">官方网站</td>
<td>&nbsp;<a href="http://www.krrjgf.com/?tracert=AdminMain" target="_blank">http://www.krrjgf.com</a></td>
</tr>
<tr>
<td class="tl">支持论坛</td>
<td>&nbsp;<a href="http://bbs.krrjgf.com/?tracert=AdminMain" target="_blank">http://bbs.krrjgf.com</a></td>
</tr>
<tr>
<td class="tl">使用帮助</td>
<td>&nbsp;<a href="http://help.krrjgf.com/?tracert=AdminMain" target="_blank">http://help.krrjgf.com</a></td>
</tr>
<tr>
...
var krrjgf_release = <?php echo DT_RELEASE;?>;
var krrjgf_version = <?php echo DT_VERSION;?>;
if(typeof krrjgf_lastrelease != 'undefined') {
	var lastrelease = parseInt(krrjgf_lastrelease.replace('-', '').replace('-', ''));
	if(krrjgf_lastversion == krrjgf_version && krrjgf_release < lastrelease) {
		Dd('tips_update').style.display = '';
		Dd('last_v').innerHTML = krrjgf_lastversion;
		Dd('last_r').innerHTML = krrjgf_lastrelease;
	}
}
</script>
<?php } ?>
